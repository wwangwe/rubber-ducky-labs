...
export const Contact = () => {
    return (
        <>
            ...
            <section className="container px-4 md:mx-auto py-4 md:py-12">
                <div className="flex flex-wrap justify-between gap-y-2 px-30">
                    <div className="w-full md:w-1/2">
                        ...
                        <div className="uppercase">
                            <Fade triggerOnce cascade damping={0.5} direction="up">
                                <p className="mb-4">
                                    <i className='fa-brands fa-linkedin fa-md md:fa-lg mr-2' />
                                ...
                                <p className="mb-4">
                                    <i className="fa-solid fa-envelope fa-md md:fa-lg mr-2" />
                                ...
                                <p className="mb-4">
                                    <i className="fa-brands fa-twitter fa-md md:fa-lg mr-2" />
                                    <small>Twitter / <a href="https://twitter.com/RubberDuckyLabs" className="underline hover:text-primary">Rubber Ducky Labs</a> </small>
                                </p>
                                <p className="mb-4">
                                    <i className="fa-solid fa-location-dot fa-md md:fa-lg mr-2" />
                                    <small>San Francisco, California, USA</small>
                                </p>
                            </Fade>
                        </div>
                    </div>
