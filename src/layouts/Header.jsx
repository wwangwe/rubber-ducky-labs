...
export const Header = () => {
    ...
    return (
        <header className="relative flex justify-center items-center h-[105vh] sm:h-[105vh] -mt-20" style={headerStyle}>
            ...
            <div className="relative flex flex-col justify-center items-center space-y-8 px-0 text-center">
                <Fade cascade triggerOnce damping={0.5} direction="up">
                    <h2 className="text-white uppercase leading-[1.5] text-sm sm:text-2xl lg:text-4xl tracking-[5px] lg:tracking-[10px]">Discover the Potential <br className="" /> of Your Recommendations</h2>
