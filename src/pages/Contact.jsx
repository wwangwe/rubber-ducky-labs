                    ...
                    <div className="flex flex-wrap justify-between">
                        <div className="w-full md:w-1/2">
                            <Fade triggerOnce cascade damping={0.5} direction="up">
                                <h3 className="py-4 text-center">We Are Social</h3>
                            </Fade>
                            <div className="uppercase">
                                <Fade triggerOnce cascade damping={0.5} direction="up">
                                    <p className="mb-2">
                                        <i className='hidden sm:block fa-brands fa-linkedin fa-md sm:fa-lg mr-2' />
                                    ...
                                    <p className="mb-2">
                                        <i className="hidden sm:block fa-solid fa-envelope fa-md sm:fa-lg mr-2" />
                                    ...
                                    <p className="mb-2">
                                        <i className="hidden sm:block fa-brands fa-twitter fa-md sm:fa-lg mr-2" />
                                        <small>Twitter / <a href="https://twitter.com/RubberDuckyLabs" className="underline hover:text-primary">Rubber Ducky Labs</a> </small>
                                    </p>
                                    <p className="mb-2">
                                        <i className="hidden sm:block fa-solid fa-location-dot fa-md sm:fa-lg mr-2" />
                        ...
                        <div className="w-full md:w-1/2">
                            <Fade triggerOnce cascade damping={0.5} direction="up">
                                <h3 className="py-4 text-center">Quack Us Up! </h3>
                            </Fade>
