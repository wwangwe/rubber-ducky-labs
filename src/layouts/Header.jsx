...
export const Header = () => {
    return (
        <header className="relative flex justify-center items-center h-[102vh] -mt-20 bg-gradient-to-b from-secondary to-accent">
            <div className="relative flex flex-col justify-center items-center space-y-8 md:space-y-10 px-80 text-center">
                <Fade cascade triggerOnce damping={0.5} direction="up">
                    <h2 className="text-white uppercase leading-[1.5]">Discover the Potential <br /> of Your Recommendations</h2>
